# R/revision/20_verify_reported_numbers.R ---------------------------------------
...
# `results/revision/verification_audit.csv`, one row per quantity checked.
...
if (any(!audit$passed)) stop("verification failed: see results/revision/verification_audit.csv")
