#!/usr/bin/env python3
"""Step 16b: independent re-derivation of results/revision/assumed_effect_scenarios.csv.

Run `Rscript R/revision/16_export_scenario_inputs.R` first.
...
TMP = os.path.join(ROOT, "results", "revision", "intermediate")
OUT = os.path.join(ROOT, "results", "revision", "assumed_effect_scenarios.csv")
