# R/revision/16_export_scenario_inputs.R ----------------------------------------
...
# `results/revision/assumed_effect_scenarios.csv` from scratch in another language.
#
...
message("now run: python3 R/revision/17_verify_scenarios.py")
