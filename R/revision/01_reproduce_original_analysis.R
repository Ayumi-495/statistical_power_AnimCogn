# R/revision/01_reproduce_original_analysis.R -----------------------------------
...
# stated method, not an error in the port; see results/revision/README.md.
#
# `S2_v2.R` is not sourced. The estimates are built by the already-committed
# R/01_estimates.R, sourced into a PRIVATE environment because its bottom-of-file
# guard fires when sourced into the global environment and would overwrite outputs/.
...
env <- new.env()
sys.source(here::here("R", "01_estimates.R"), envir = env)
