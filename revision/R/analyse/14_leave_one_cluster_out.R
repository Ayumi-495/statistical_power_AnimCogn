# revision/R/analyse/14_leave_one_cluster_out.R -----------------------------------------
...
# simulation and everything in revision/results/ is analytic.
#
...
SRC <- here::here("revision", "results", "reproduce", "B5_leave_one_study_out_rows.csv")
if (!file.exists(SRC))
  stop("Row-level leave-one-out output not found: ", SRC,
       "\nRegenerate it with revision/R/reproduce/05_loo_study.R before running this script.")
