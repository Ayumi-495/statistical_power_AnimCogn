# revision/R/analyse/15_leave_one_paper_out.R -------------------------------------------
...
#
# An earlier leave-one-paper-out was computed during the reproduce phase and has been
# deleted rather than kept: it predated the adopted clustering, used a Monte Carlo Type M,
# and covered only the uncorrected and Yang-2023 specifications. If an old copy surfaces,
# it must not be quoted alongside these numbers.
#
