# revision/R/analyse/09_assumed_effect_scenarios.R -------------------------------------
...
# they use the same closed-form metrics as everything else in revision/results/.
...
# the end of this script and revision/results/README.md.
...
#   Rscript revision/R/analyse/16_export_scenario_inputs.R && python3 revision/R/analyse/17_verify_scenarios.py
