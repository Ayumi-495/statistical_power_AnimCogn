# revision/R/analyse/04_revision_sensitivity_summaries.R -------------------------------
...
primary_rows <- purrr::list_rbind(lapply(seq_len(nrow(primary_specs)), function(i) {
  ...
  d <- purrr::list_rbind(lapply(seq_along(L), function(j) {
    ...
    tibble::tibble(MA_model = o$MA_model[j],
                   ...
                   # across meta-analyses; see revision/results/README.md.
...
# 07_influence_loo.R and revision/results/README.md section 3).
#
