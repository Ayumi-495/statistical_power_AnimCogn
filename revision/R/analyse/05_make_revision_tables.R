# revision/R/analyse/05_make_revision_tables.R -----------------------------------------
# Step 5: assemble the canonical, machine-readable result tables.
#
# Writes to revision/results/:
...
# External-corpus comparisons are documented in revision/results/README.md with
...
message("\ncanonical tables in revision/results/:")
